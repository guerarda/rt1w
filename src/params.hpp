...
struct Params : Object {
    ...
    virtual void merge(const std::map<const std::string, const sptr<Params>> &params) = 0;
    ...
    static std::string string(const sptr<Params> &p, const std::string &n, const std::string &v);
};
